...
class Gateway_Skrill_OBT extends Skrill_Payment_Gateway {
	 ...
	 * @var array
	 */
	protected $allowed_countries = array( 'AUT', 'BEL', 'DNK', 'EST', 'FIN', 'FRA', 'DEU', 'IRL', 'ITA', 'LVA', 'LTU', 'NLD', 'PRT', 'ROU', 'ESP', 'GBR' );
	 ...
	 * @var string
	 */
	public $payment_method_description = 'Austria, Belgium, Denmark, Estonia, Finland, France, Germany, Ireland, Italy, Latvia, Lithuania, Netherlands, Portugal, Romania, Spain, United Kingdom';
