...
final class Skrill_Ewltkr_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_ewltkr'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'KOR' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-ewltkr-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_ewltkr_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-ewltkr-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/ewltkr.png',
