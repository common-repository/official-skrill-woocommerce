...
final class Skrill_Wlt_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_wlt'; // payment gateway id
    ...
    {
        wp_register_script(
            'wc-skrill-wlt-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_wlt_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-wlt-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/wlt.png',
