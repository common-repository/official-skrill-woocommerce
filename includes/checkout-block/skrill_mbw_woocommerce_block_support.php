...
final class Skrill_Mbw_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_mbw'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'PRT' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-mbw-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_mbw_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-mbw-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/mbw.png',
