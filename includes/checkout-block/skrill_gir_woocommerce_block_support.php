...
final class Skrill_Gir_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_gir'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'DEU' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-gir-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_gir_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-gir-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/gir.png',
