...
final class Skrill_Pgf_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_pgf'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'PER' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-pgf-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_pgf_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-pgf-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/pgf.png',
