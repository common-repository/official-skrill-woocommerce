...
final class Skrill_Ewltph_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_ewltph'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'PHL' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-ewltph-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_ewltph_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-ewltph-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/ewltph.png',
