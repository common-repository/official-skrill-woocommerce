...
final class Skrill_Sft_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_sft'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'DEU', 'AUT', 'BEL', 'NLD', 'FRA', 'HUN', 'SVK', 'CZE', 'GBR' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-sft-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_sft_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-sft-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/sft.png',
