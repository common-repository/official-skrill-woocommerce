...
final class Skrill_Mae_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_mae'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'GBR', 'ESP', 'IRL', 'AUT' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-mae-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_mae_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-mae-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/mae.png',
