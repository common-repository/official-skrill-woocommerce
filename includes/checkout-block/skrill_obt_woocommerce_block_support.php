...
final class Skrill_Obt_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_obt'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'AUT', 'BEL', 'DNK', 'EST', 'FIN', 'FRA', 'DEU', 'IRL', 'ITA', 'LVA', 'LTU', 'NLD', 'PRT', 'ROU', 'ESP', 'GBR' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-obt-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_obt_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-obt-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/obt.png',
