...
final class Skrill_Psc_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_psc'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'BEL', 'HRV', 'CYP', 'CZE', 'DNK', 'EST', 'FIN', 'GEO', 'GIB', 'HUN', 'IRL', 'KWT', 'LVA', 'LIE', 'LTU', 'LUX', 'MLT', 'MEX', 'NLD', 'NOR', 'PER', 'PRT', 'ROU', 'SAU', 'SVK', 'SVN', 'SWE', 'SWZ', 'URY' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-psc-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_psc_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-psc-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/psc.png',
