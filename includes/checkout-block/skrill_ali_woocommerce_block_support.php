...
final class Skrill_Ali_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_ali'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'CHN' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-ali-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_ali_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-ali-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/ali.png',
