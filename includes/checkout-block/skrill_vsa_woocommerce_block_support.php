...
final class Skrill_Vsa_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_vsa'; // payment gateway id
    ...
    {
        wp_register_script(
            'wc-skrill-vsa-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_vsa_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-vsa-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url(__DIR__) . '../assets/images/vsa.png',
