...
final class Skrill_Aci_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_aci'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'ARG', 'BRA', 'CHL', 'COL', 'MEX', 'PER', 'URY' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-aci-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_aci_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-aci-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/aci.png',
