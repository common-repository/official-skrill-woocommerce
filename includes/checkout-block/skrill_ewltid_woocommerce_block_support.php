...
final class Skrill_Ewltid_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_ewltid'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'IDN' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-ewltid-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_ewltid_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-ewltid-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/ewltid.png',
