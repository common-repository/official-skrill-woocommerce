...
final class Skrill_Aob_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_aob'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'BRA', 'CHL', 'COL' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-aob-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_aob_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-aob-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/aob.png',
