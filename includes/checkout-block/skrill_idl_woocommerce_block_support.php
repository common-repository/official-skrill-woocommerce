...
final class Skrill_Idl_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_idl'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'NLD' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-idl-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_idl_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-idl-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/idl.png',
