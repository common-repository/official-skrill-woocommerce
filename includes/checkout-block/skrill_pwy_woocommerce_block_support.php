...
final class Skrill_Pwy_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_pwy'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'POL' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-pwy-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_pwy_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-pwy-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/pwy.png',
