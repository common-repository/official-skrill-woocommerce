...
final class Skrill_Blk_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_blk'; // payment gateway id
    ...
    {
        wp_register_script(
            'wc-skrill-blk-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_blk_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-blk-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/blk.png',
