...
final class Skrill_Adb_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_adb'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'ARG', 'BRA' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-adb-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_adb_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-adb-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/adb.png',
