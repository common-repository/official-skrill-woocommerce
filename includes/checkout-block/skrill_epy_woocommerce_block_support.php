...
final class Skrill_Epy_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_epy'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'BGR' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-epy-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_epy_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-epy-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/epy.png',
