...
final class Skrill_Mbk_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_mbk'; // payment gateway id
    ...
    public function __construct() {
        ...
        $this->skrill_core->allowed_countries = array( 'ITA' );
    }
    ...
    {
        wp_register_script(
            'wc-skrill-mbk-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_mbk_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-mbk-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/mbk.png',
