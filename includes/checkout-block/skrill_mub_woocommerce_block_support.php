...
final class Skrill_Mub_Gateway_Blocks extends AbstractPaymentMethodType
{
    private $gateway;

    protected $name = 'skrill_mub'; // payment gateway id
    ...
    {
        wp_register_script(
            'wc-skrill-mub-blocks-integration',
            plugin_dir_url(__DIR__) . '../assets/js/skrill_mub_checkout.js',
            array(
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
        ...
        return array( 'wc-skrill-mub-blocks-integration' );
    }
    ...
    public function get_payment_method_data()
    {
        return array(
            ...
            'icon'         => plugin_dir_url( __DIR__ ) . '../assets/images/mub.png',
